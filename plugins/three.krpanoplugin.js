...
function krpanoplugin() {
	...
	function build_scene() {
		...
		// load 3d objects
		load_object_json("plugins/wolf.js", false, { ath: +30, atv: +15, depth: 500, scale: 1, rx: 180, ry: 60, rz: 0, ondown: function (obj) { obj.properties.scale *= 1.2; update_object_properties(obj); }, onup: function (obj) { obj.properties.scale /= 1.2; update_object_properties(obj) } }, function (obj) { obj.material.color.setHex(0xAA5522); });
		...
		box = new THREE.Mesh(new THREE.BoxGeometry(500, 500, 500), new THREE.MeshBasicMaterial({ map: THREE.ImageUtils.loadTexture(resolve_url_path("plugins/box.jpg")) }));
		assign_object_properties(box, "box", { ath: 4, atv: -3, depth: 2000, ondown: function (obj) { obj.properties.scale *= 1.2; }, onup: function (obj) { obj.properties.scale /= 1.2; } });
		scene.add(box);
	...
	function do_object_hittest(mx, my) {
		var mouse_x = (mx / krpano.area.pixelwidth) * 1.0 - 1.0;
		var mouse_y = (my / krpano.area.pixelheight) * 1.0 - 1.0;
